                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form method="POST" action="{{ route('hotels.store') }}" class="form-group"
                                    enctype="multipart/form-data">

                                    @csrf
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Hotel " name="name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <a href="{{ route('hotels.index') }}" class="btn btn-danger">Cancel</a>
                                </form>
