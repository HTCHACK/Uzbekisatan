    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 newsletter__content">
                <img src="{{ asset('assets/images/icon_mail.png') }}" alt="Newsletter" class="newsletter__icon">
                <div class="newsletter__text-content">
                    <h2 class="newsletter__title">{{ __('lang.subscribe') }}</h2>
                    <p class="newsletter__desc">{{ __('lang.subscribe_news') }}</p>
                </div>
            </div><!-- .col -->

            <div class="col-md-6">
                <form action="{{ route('emails.store') }}" class="newsletter__form" method="POST">
                    @csrf
                    <input type="email" name="email" class="newsletter__field"
                        placeholder="{{ __('lang.enter_email') }}">
                    <input type="submit" class="newsletter__submit" value="{{ __('lang.subscribe') }}"/>
                </form>
            </div><!-- .col -->
        </div><!-- .row -->
    </div><!-- .container -->
    ...
    <div class="footer__main">
        <div class="container">
            <div class="footer__logo">
                <h1 class="screen-reader-text">{{ __('lang.lorem') }}</h1>
                <img src="{{ asset('assets/images/map1.png') }}" alt="" width="60px">
            </div><!-- .footer__logo -->
            <p class="footer__desc">{{ __('lang.lorem') }} </p>
            <ul class="footer__social">
                <li><a href="https://www.facebook.com/asadbek.khalimjonov"><i class="fa fa-facebook"
                            aria-hidden="true"></i></a></li>
                <li><a href="https://twitter.com/Asadbek03345075"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                </li>
                <li><a href="https://www.youtube.com/channel/UCI1gVEIfjjrYIYC9OZlwWyg"><i class="fa fa-youtube-play"
                            aria-hidden="true"></i></a></li>
                <li><a href="https://www.linkedin.com/in/asatbekxalimjonov/"><i class="fa fa-linkedin"
                            aria-hidden="true"></i></a></li>
                <li><a href="https://www.instagram.com/Liverpool_unoffical/"><i class="fa fa-instagram"
                            aria-hidden="true"></i></a></li>
                <li><a href="https://t.me/asadbekxalimjonov"><i class="fa fa-paper-plane" aria-hidden="true"></i></a>
                </li>
            </ul><!-- .footer__social -->
        </div><!-- .container -->
    </div><!-- .footer__main -->
        ...
        <div class="container">
            <div class="footer__copyright-inner">
                <p class="footer__copyright-desc">
                    &copy; 2021 <span class="footer--highlighted">Uzbekistan</span> Uzbekistan. All Right Reserved.
                </p>
                <ul class="footer__copyright-list">
                    <li><a href="{{ route('home') }}">{{ __('lang.home') }}</a></li>
                    <li><a href="{{ route('regionsuz.index') }}">{{ __('lang.regions') }}</a></li>
                    <li><a href="{{ route('mappage.map') }}">{{ __('lang.map') }}</a></li>
                    <li><a href="{{ route('galleriesuz.index') }}">{{ __('lang.gallery') }}</a></li>
                    <li><a href="{{ route('contactsuz.index') }}">{{ __('lang.contact') }}</a></li>
