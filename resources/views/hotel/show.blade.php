...
@section('title')
<title>{{__('lang.uzbekistan')}} | {{__('lang.hotels')}}</title>
@endsection
@section('content')
        ...
        <div class="row">
          <main class="col-md-8 col-md-main">
            <div class="about-us__img">
              <img src="{{ asset('storage/' . $hotel->img) }}" width="100%" style="height:320px" alt="About us">
            </div><!-- .about-us__img -->
            <h1 class="about-us__title">{{$hotel->name}}</h1>
            <p>
            {!!$hotel->description!!}
            </p>
          </main><!-- .col -->
